                ...
                <tbody>
                  ...
                  <?php foreach ($data as $row) { ?>
                    <tr class="text-center">
                      ...
                      <td><?= $row->jumlah ?></td>
                      <td>
                        <a class="btn btn-warning" href="<?= base_url('Pakan/edit_data/' . $row->id); ?>">
                          <i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger" href="<?= base_url('Pakan/delete_pakan') ?>/<?= $row->id ?>" onclick="return confirmToDelete(this)"><i class="fa fa-trash"></i></a>
